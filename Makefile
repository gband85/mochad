...
pkgdatadir = $(datadir)/mochad
pkgincludedir = $(includedir)/mochad
pkglibdir = $(libdir)/mochad
pkglibexecdir = $(libexecdir)/mochad
...
am_mochad_OBJECTS = mochad.$(OBJEXT) decode.$(OBJEXT) encode.$(OBJEXT) \
	global.$(OBJEXT) x10state.$(OBJEXT) x10_write.$(OBJEXT)
mochad_OBJECTS = $(am_mochad_OBJECTS)
mochad_LDADD = $(LDADD)
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(mochad_SOURCES)
DIST_SOURCES = $(mochad_SOURCES)
...
STRIP = 
VERSION = 0.1.17
abs_builddir = /home/pi/mochad-0.1.21
abs_srcdir = /home/pi/mochad-0.1.21
abs_top_builddir = /home/pi/mochad-0.1.21
abs_top_srcdir = /home/pi/mochad-0.1.21
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/pi/mochad-0.1.21/install-sh
...
mochad$(EXEEXT): $(mochad_OBJECTS) $(mochad_DEPENDENCIES) $(EXTRA_mochad_DEPENDENCIES) 
	@rm -f mochad$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(mochad_OBJECTS) $(mochad_LDADD) $(LIBS)
...
include ./$(DEPDIR)/mochad.Po
include ./$(DEPDIR)/x10_write.Po
include ./$(DEPDIR)/x10state.Po
...
install-exec-hook:
	if test -d /lib/systemd/system -a -x /bin/systemctl ; then \
		cp $(abs_top_srcdir)/systemd/mochad.service /lib/systemd/system ; \
